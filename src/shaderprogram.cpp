...
) // Wyłączenie błędu w Visual Studio wynikające z nietrzymania się standardów przez Microsoft.
...
GLuint ShaderProgram::loadShader(GLenum shaderType, const char *fileName) {
	...
	GLuint shader =
		glCreateShader(shaderType); // shaderType to GL_VERTEX_SHADER, GL_GEOMETRY_SHADER lub GL_FRAGMENT_SHADER
