...
void drawScene(GLFWwindow *window, float angle_x, float angle_y) {
	...
	glm::mat4 V =
		glm::lookAt(glm::vec3(0, 0, -4), glm::vec3(0, 0, 0), glm::vec3(0.0f, 1.0f, 0.0f)); // Wylicz macierz widoku
	...
	glVertexAttribPointer(sp->a("vertex"), 4, GL_FLOAT, false, 0, vertices); // Wskaż tablicę z danymi dla atrybutu
																			 // vertex
	...
	glVertexAttribPointer(sp->a("texCoord0"), 2, GL_FLOAT, false, 0, texCoords); // Wskaż tablicę z danymi dla atrybutu
																				 // texCoord
